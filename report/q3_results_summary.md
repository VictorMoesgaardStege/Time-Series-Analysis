...
## 3.1 Time Series
**Figure (PNG):** `report/figures/q3_31_time_series.png`
**Figure (PDF):** `report/figures/q3_31_time_series.pdf`
**Ph range:** 14 - 98 W
...
**Figure A (scatter, PNG):** `report/figures/q3_33_scatter.png`
**Figure A (scatter, PDF):** `report/figures/q3_33_scatter.pdf`
**Figure B (ACF/PACF/CCF, PNG):** `report/figures/q3_33_acf_ccf.png`
**Figure B (ACF/PACF/CCF, PDF):** `report/figures/q3_33_acf_ccf.pdf`
...
**Figure (PNG):** `report/figures/q3_34_impulse_response.png`
**Figure (PDF):** `report/figures/q3_34_impulse_response.pdf`
...
**Figure (PNG):** `report/figures/q3_35_lm_diagnostics.png`
**Figure (PDF):** `report/figures/q3_35_lm_diagnostics.pdf`
...
**Figure (PNG):** `report/figures/q3_36_arx1_diagnostics.png`
**Figure (PDF):** `report/figures/q3_36_arx1_diagnostics.pdf`
...
**Figure (PNG):** `report/figures/q3_37_aic_bic.png`
**Figure (PDF):** `report/figures/q3_37_aic_bic.pdf`
**Table:** `report/tables/q3_37_ic.tex`
**All ARX models were fitted on the training set only, without intercept.**
...
**Figure (PNG):** `report/figures/q3_38_rmse.png`
**Figure (PDF):** `report/figures/q3_38_rmse.pdf`
**Table:** `report/tables/q3_38_rmse.tex`
**Best order by RMSE:** 3 (RMSE = 2.8755 W)
**All RMSE comparisons are based on models fitted on the training set only.**
**RMSE values (p=1..10):** 3.752, 3.245, 2.875, 3.039, 3.126, 3.332, 3.323, 3.269, 3.26, 3.302

## 3.9 Multi-Step Simulation
**Figure (PNG):** `report/figures/q3_39_multistep_simulation.png`
**Figure (PDF):** `report/figures/q3_39_multistep_simulation.pdf`
**Table (coefficients):** `report/tables/q3_39_arx3_coef.tex`
**Model used:** ARX(3), selected by test-set RMSE
**Simulation RMSE - training period:** 2.249 W
**Simulation RMSE - test period:** 3.669 W
**Coefficients:**
  - Ph.l1: 0.3784
  - Ph.l2: 0.1823
  - Ph.l3: -7e-04
